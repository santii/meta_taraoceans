...
# for run in $runs
# do
#     bowtie2 -x $index_remo -1 "$trimmed$slash$run"_1_trim.fastq -2 "$trimmed$slash$run"_2_trim.fastq -S "$removal"/all_"$run".sam -p 32
#     rm "$trimmed$slash$run"_1_trim.fastq
#     rm "$trimmed$slash$run"_2_trim.fastq
#     echo "########## FINAL DA all_"$run".sam ##########"
# done
# 
